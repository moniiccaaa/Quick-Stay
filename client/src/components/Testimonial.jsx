  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 bg-slate-50 pt-20 pb-30'>
        <Title 
            ...
            subTitle="Discover why discerning travellers consistently
            choose QuickStay for their exclusive and luxurious accommodation around the world."
        />

         <div className="flex flex-wrap items-center gap-1 mt-20">
