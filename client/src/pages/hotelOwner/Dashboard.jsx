...
const Dashboard = () => {
  ...
  return (
    <div>
        <Title align='left' font='outfit' title='Dashboard' subTitle='Monitor your room listings, track belongings amd analyze revenue-all in one place. Stay updated with real-time insights to ensure smooth operations.'/>
        ...
        <div className='flex gap-4 my-8'>
            ...
            <div className='bg-primary/3 border border-primary/10 rounded flex p-4 pr-8'>
                ...
                <div className='fles flex-col sm:ml-4 font-medium'>
                ...
                <tbody className='text-sm'>
                    {dashboardData.bookings.map((item, index)=>(
                        <tr key={index}>
                            ...
                            <td className='py-3 px-4 text-gray-700 border-t border-gray-300 text-center'>Rs. {item.totalPrice}</td>
